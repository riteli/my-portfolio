  ...
  return (
    <section id="works" className="w-full max-w-4xl mx-auto py-20 px-6">
      ...
      <div className="relative">
        ...
        <div className="w-full h-4 mt-0 border-t-4 border-border-white-10 bg-linear-to-b from-white/5 to-transparent transform translate-y-4 rounded-full opacity-50" />
      </div>
    </section>
  );
}
